...
export default function ConferenciasPage() {
  return (
    <>
      ...
      {/* SOCIAL PROOF — Galería de eventos reales */}
      <section className="bg-tinto-deep py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-16">
              <p className="mono-label text-beige mb-4" style={{ color: "#D6C7AE" }}>
                — TALLERES Y EVENTOS REALES —
              </p>
              <h2 className="font-display text-4xl md:text-6xl text-ivory leading-[1.05]">
                <span className="italic">200+ mujeres formadas</span><br />
            ...
            <Reveal delay={100} className="col-span-12 md:col-span-8">
              <div className="relative aspect-[4/3] overflow-hidden">
                <Image
                  ...
                  alt="Taller Mi Versión Más Auténtica en Werkshop con grupo de alumnas"
                  fill
                  className="object-cover"
            ...
            <Reveal delay={150} className="col-span-12 md:col-span-4">
              <div className="relative aspect-[3/4] md:aspect-auto md:h-full overflow-hidden">
                <Image
                  ...
                  alt="Sarahi Haro impartiendo workshop corporativo"
                  fill
                  className="object-cover"
          ...
          <Reveal delay={300}>
            <p className="mono-label text-beige/70 text-center mt-12 max-w-2xl mx-auto" style={{ color: "rgba(214,199,174,0.7)" }}>
              MÉXICO · ESTADOS UNIDOS · WORKSHOPS CORPORATIVOS · COMUNIDADES PRIVADAS · EVENTOS DE EMPRENDEDORAS
            </p>
          </Reveal>
        </div>
      </section>
